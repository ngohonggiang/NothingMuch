...
app.get('/music', (reg, res)=> res.render('/song.handlebars'));
app.get('/video', (reg, res)=> res.render('/video.handlebars'));
app.get('/', (reg, res)=>{
    res.render('/index.handlebars');
    console.log(__dirname+'hee');
